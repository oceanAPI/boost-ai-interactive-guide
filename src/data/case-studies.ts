...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    id: "islandsbanki",
    companyType: "Banking",
    headline: "Íslandsbanki automates 50% of chat traffic in 6 months",
    companyDescription: "One of three major banks in Iceland, offering corporate banking, asset management, and retail banking. Founded 1884.",
    relevantIndustries: ["banking", "fintech"],
    channel: "chat",
    ...
    results: [
      ...
      { metric: "Customer satisfaction", value: "85-90%", improvement: "positive feedback on bot responses" },
    ],
    timeline: "2-day POC in 2019; 50% automation within 6 months of launch",
    sourceUrl: "https://boost.ai/case-studies/islandsbanki-automates-50-of-all-chat-traffic-in-just-6-months/",
    quote: {
      text: "In my experience, there is no such thing as plug-and-play in financial services, but boost.ai is as close to a real plug-and-play solution as we have experienced.",
      author: "Logi Karlsson",
      role: "Executive Director, Íslandsbanki",
    },
  },
  {
    id: "genesys-partnership",
    companyType: "Partnership",
    headline: "Voice handover for regulated industries",
    companyDescription: "Boost.ai × Genesys Cloud — one conversational brain across chat and voice, with Genesys-routed human handover.",
    relevantIndustries: [],
    channel: "both",
    image: "/photos/case-studies/genesys-partnership.png",
    logoUrl: "/logos/genesys.svg",
    videoUrl: "https://www.youtube.com/watch?v=NwI-1ohb__s",
    context: { industry: "Partnership" },
    challenge: "Regulated industries need hyper-personalized service across chat AND voice while maintaining compliance, security, and seamless human handover. Stitching those capabilities together from separate vendors creates fragmented experiences and fragile integrations.",
    solution: "Boost.ai's GenAI platform deploys inside Genesys Cloud, giving a single conversational brain across channels. The voice handover demo shows how a conversation started with the AI agent passes cleanly — with full context — to a Genesys-routed human agent when escalation is needed.",
    results: [
      { metric: "Channels covered", value: "Chat + Voice" },
      { metric: "Listed on", value: "Genesys AppFoundry" },
      { metric: "Live deployment", value: "Íslandsbanki", improvement: "50% chat automation in 6 months" },
    ],
    timeline: "Joint solution — available via boost.ai and Genesys AppFoundry",
