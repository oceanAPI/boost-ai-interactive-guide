...
export const SLIDE_SECTIONS: SlideSection[] = [
  ...
  { id: "intent-traffic",           label: "Intent Traffic",            group: "proof",      minutes: 3,  hint: "Conversation analytics from a boost.ai intent-traffic export — automation/escalation/unsolved split per intent", defaultEnabled: false },
  { id: "detected-issues",          label: "Detected Issues & Next Moves", group: "proof",   minutes: 3,  hint: "The CS decision engine — issues detected from the customer's metrics + the prioritised initiatives to act on", defaultEnabled: false },
  ...
  { id: "success-stories",          label: "Success Stories",           group: "proof",      minutes: 3,  hint: "Curated success-story library — CSM hand-picks references, with a per-engagement anonymise toggle", defaultEnabled: false },
